...
//                  Includes combined loop condition to stop iteration
//                  early when the sum of factors reaches the number.
...
public:
    ...
    bool CheckPerfect(int iNo)
    {
        ...
        // Combined loop condition for optimized execution
